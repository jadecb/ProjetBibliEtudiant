...
//-----  Classes conteneurs et éléments de dialogue pour l'ouvrage -------------------------------------------------
    ...
    public static class InfosOuvrage {
        ...
        public InfosOuvrage(final String isbn, final String titre, final String nomEditeur, final LocalDate dateParution) {
            this.isbn = isbn;
            this.titre = titre;
    ...
    public InfosOuvrage saisirOuvrage() {
        ...
        return new InfosOuvrage(isbn, titre, nomEditeur, dateParution);
    }

    public void afficherOuvrage(final String isbn, final String titre, final String nomEditeur,
            final LocalDate dateParution) {
        ES.afficherTitre("== affichage de l'ouvrage == " + isbn);
        ES.afficherLibelle("isbn, titre, nom de l'éditeur et date de parution :" + isbn + " " + titre + " " + nomEditeur + " " + dateParution);
